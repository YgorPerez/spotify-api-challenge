...
import { type SimplifiedTrack as SimplifiedTrackType, type Track as TrackType } from 'spotify-web-api-ts-edge/types/types/SpotifyObjects'
import formatMilliseconds from '../utils/formatMilliseconds'

const Track: React.FC<{ track: SimplifiedTrackType | TrackType | null }> = ({ track }) => {
  if (!track) {
    return (
